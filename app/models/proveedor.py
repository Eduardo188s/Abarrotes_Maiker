...
class Proveedor:
    ...
    def __init__(self, nombre_proveedor, a_paterno, a_materno, direccion_proveedor, correo_proveedor, telefono_proveedor, id_proveedor=None):
    ...
    def save(self):
        ...
        # Update an Object
            ...
            with mydb.cursor() as cursor:
                sql = "UPDATE proveedor SET nombre_proveedor = %s, a_paterno = %s, a_materno = %s, direccion_proveedor = %s, correo_proveedor = %s, telefono_proveedor = %s WHERE id_proveedor = %s"
